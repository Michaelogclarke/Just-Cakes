...
export default function Cupcakespage() {
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.description.trim()) {
      setSubmitMessage('Please describe your dream cupcakes')
      return false
    }

    if (formData.description.trim().length < 10) {
      setSubmitMessage('Please provide more details about your cupcakes (at least 10 characters)')
      return false
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/cupcake-qoute-request/', {
        method: 'POST',
  ...
  return (
    <div className={styles.pageContainer}>
      ...
      <div className={styles.hero}>
        <h1>Request Your Custom Cupcakes Quote</h1>
        ...
        <form onSubmit={handleSubmit} className={styles.form}>
          ...
          <div className={styles.fieldGroup}>
            <label htmlFor="description" className={styles.label}>
              Cupcake Description <span className={styles.required}>*</span>
            </label>
            <textarea
              id="description"
              ...
              required
              rows={6}
              placeholder="Describe your dream Cupcake... Include flavors, colors, themes, design ideas, or anything else that inspires you!"
