...
async function main() {
  ...
  const products = [
    ...
    },
    {
      ...
      description: 'Vanilla cake with coconut cream filling and toasted coconut',
      price: 6.99,
    ...
    {
      id: 'slice-10',
      name: 'Triple Berry Slice',
      description: 'White cake with strawberry, raspberry, and blueberry layers',
      price: 7.49,
      image: 'https://images.unsplash.com/photo-1588195538326-c5b1e5b56dc8?w=400',
      category: 'fruit',
      occasion: 'celebration',
      type: 'slice',
      available: true
